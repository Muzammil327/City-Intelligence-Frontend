...
const WORDMARK = "City Intelligence";

const FOOTNOTE =
  "Live data from Open-Meteo, OpenWeatherMap and WAQI. Neighbourhood values are model grid points, not physical sensors.";
...
export function DashboardNav({ activeTab }: DashboardNavProps) {
  ...
  return (
    <>
      ...
      <aside className="hidden shrink-0 lg:flex lg:h-full lg:min-h-0 lg:w-60 lg:flex-col lg:gap-6 lg:border-r lg:border-white/5 lg:px-5 lg:py-6">
        ...
        {isOpen ? (
          <div className="lg:hidden">
            ...
            <motion.div
              ...
              exit={{ x: "-100%" }}
              transition={panelTransition}
              className="fixed inset-y-0 left-0 z-50 flex w-72 max-w-[85vw] flex-col gap-6 border-r border-white/10 bg-background px-5 py-6"
            >
